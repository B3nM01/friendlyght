...
;(function($, undefined) {
    $.fn.drawDoughnutChart = function(data, options) {
      ...
      var $svg = $('<svg width="' + 200 + '" height="' + 200 + '" viewBox="0 0 ' + W + ' ' + H + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:relative; z-index:2"></svg>').appendTo($this),
          $paths = [],
